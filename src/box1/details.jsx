...
const BookingPage = () => {
  ...
  const generatePDF = (transactionId) => {
    ...
    doc.autoTable({
      ...
      theme: 'striped', // Add striped theme for better visibility
      styles: {
        fontSize: 12,
        cellPadding: 5,
        halign: 'center',
      ...
      headStyles: {
        fillColor: [22, 160, 133], // Set header color to a teal shade
        textColor: 255,
        fontSize: 14,
      },
      alternateRowStyles: {
  ...
  return (
    <Container>
      <div>
      <h1 className="text-center my-4">Booking Page</h1>
      <Form>
        ...
        <Form.Group controlId="bookingDate" className="mt-3">
        ...
        {paymentMethod === "card" && (
          <Button className="mt-4" variant="primary" onClick={() => handlePayment(true)}>
            Confirm Booking
          </Button>
        )}
      </Form>
