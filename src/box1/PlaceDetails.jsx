...
const PlaceDetails1 = () => {
  ...
  if (!place) {
    return (
      <Container className="mt-4 text-center">
        <h1 className="text-danger">Place Not Found</h1>
        <p>Please try booking another place.</p>
      </Container>
    );
  }
  ...
  return (
    <Container className="mt-4">
      ...
      <Card className="p-3">
        <Row>
          <Col md={6} className="mb-3" style={{ marginLeft: "-20px" }}>
            <Carousel>
              {place.images?.map((image, index) => (
                <Carousel.Item key={index}>
                  <img className="d-block w-100" src={image} alt={`Slide ${index}`} />
          ...
          <Col md={6} style={{ marginLeft: "-20px" }}>
            <Card.Body>
              <Card.Text><strong>Address:</strong> {place.address}</Card.Text>
              <Card.Text>{place.description}</Card.Text>
      ...
      <div className="text-center mt-4">
        <Button variant="primary" onClick={handleBookClick} className="px-4 py-2">
          Book Now
        </Button>
      </div>
        ...
        <>
          ...
          {selectedDate && paymentMethod && (
            <Card className="mt-4 p-3 text-center">
              ...
              <p><strong>Date & Time:</strong> {selectedDate.toString()}</p>
              <p><strong>Payment Method:</strong> {paymentMethod}</p>
              <p><strong>Total Cost:</strong> ₹{place.pricePerHour}</p>
              <Button variant="success" onClick={handleGenerateBill}>
                Confirm and Generate Bill
              </Button>
            </Card>
