...
const ContactUs = ({}) => {
  ...
  return (
    ...
    <div>
            ...
            <Nav className="ms-auto align-items-center">
              ...
              <Nav.Link href="/login" className="mx-2 d-flex align-items-center">
                <img
                  src={Loginicon}
                  alt="Login"
                  style={{ height: "30px", width: "30px", borderRadius: "50%", marginRight: "7px" }}
                />
                Login
              </Nav.Link>
     ...
     <div className= {`contact-container ${isActive ? "active" : ""}`}>
        <h1 className="contact-heading">Get in Touch</h1>
        <p className="contact-description">Have questions or need help? Feel free to reach out to us!</p>
